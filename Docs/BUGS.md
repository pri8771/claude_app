...
|---|---|---|---|---|---|
| HIND-B01 | high | Capture layout | Sticky navigation competes with lower controls on the audited iPhone Air wizard screen. | resolved | commit 2670ada — all four wizard steps reserved only 12pt bottom clearance against an ~82pt sticky nav bar; raised to 100pt. Verified: 121/121 unit tests, 6/6 UI tests pass including two at largest accessibility text size. Not re-verified on physical iPhone Air. |
