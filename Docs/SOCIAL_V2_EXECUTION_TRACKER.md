...
| F0.7 | Provision isolated services/secrets and implement CI, compatibility, observability, flags, promotion and rollback. Local gates and typed default-off iOS rollout policy pass locally; integrated client suite is 80/80; hosted foundation run 30591583112 passes the complete shared scheme and repository gates. | Accepted ADR/provider access; real-manifest/project isolation, observability, and successful rollback game day. | `in_progress` |
